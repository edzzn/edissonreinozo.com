		...
		<div class="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
			...
			<div class="space-y-8">
				<div>
					...
					<div class="space-y-4">
						<a
							href="mailto:edisson@punto593.com"
						...
						>
							...
							<div>
								...
								<p class="text-muted-foreground text-sm">edisson@punto593.com</p>
							</div>
						</a>
						...
						>
							...
							<div>
								<h3 class="text-foreground font-medium">LinkedIn</h3>
								<p class="text-muted-foreground text-sm">linkedin.com/in/edzzn</p>
							</div>
						</a>
